...
const celebrations = [
  { title: 'ليلة الحناء', day: 'الجمعة', number: '23', date: '2026-10-23', description: 'نبدأ فرحتنا بليلة الحناء' },
  { title: 'حفل الزفاف', day: 'الأحد', number: '25', date: '2026-10-25', description: 'ونحتفل معكم ببداية حكايتنا' },
];
